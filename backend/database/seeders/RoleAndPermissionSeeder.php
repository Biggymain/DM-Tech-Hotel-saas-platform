...
class RoleAndPermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $roles = [
            ...
            'branchmanager' => ['restaurant.orders.manage', 'orders.view', 'orders.create', 'orders.update', 'orders.delete', 'inventory.manage', 'inventory.view', 'reports.view', 'reports.export', 'users.view', 'users.create', 'notifications.view', 'pos.manage', 'leisure.manage'],
